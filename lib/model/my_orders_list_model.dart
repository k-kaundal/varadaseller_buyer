...
class MyOrder {
  ...
  factory MyOrder.fromJson(Map<String, dynamic> json) => MyOrder(
        ...
        city: int.parse(json["city"].toString()=="null"?"0":json["city"].toString()),
        area: int.parse(json["area"].toString()=="null"?"0":json["area"].toString()),
        country: int.parse(json["country"].toString()=="null"?"0":json["country"].toString()),
        ...
        commissionCharge: int.parse(json["commission_charge"].toString()=="null"?"0":json["commission_charge"].toString()),
        commissionAmount: json["commission_amount"],
        paymentGateway: json["payment_gateway"],
        paymentStatus: json["payment_status"],
        status: int.parse(json["status"].toString()=="null"?"0":json["status"].toString()),
        isOrderOnline: int.parse(json["is_order_online"].toString()=="null"?"0":json["is_order_online"].toString()),
        orderCompleteRequest: int.parse(json["order_complete_request"].toString()=="null"?"0":json["order_complete_request"].toString()),
        cancelOrderMoneyReturn: int.parse(json["cancel_order_money_return"].toString()=="null"?"0":json["cancel_order_money_return"].toString()),
