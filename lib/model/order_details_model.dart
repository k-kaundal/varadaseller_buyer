...
class OrderInfo {
  ...
  factory OrderInfo.fromJson(Map<String, dynamic>? json) => OrderInfo(
        ...
        country: int.parse(json?["country"]),
        ...
        commissionCharge: int.parse(json?["commission_charge"]),
        commissionAmount: double.parse(json?["commission_amount"]).toDouble(),
        paymentGateway: json?["payment_gateway"],
        paymentStatus: json?["payment_status"],
        status: json?["status"],
        isOrderOnline: json?["is_order_online"],
        orderCompleteRequest: int.parse(json?["order_complete_request"]),
        cancelOrderMoneyReturn: int.parse(json?["cancel_order_money_return"]),
...
class Seller {
  ...
  factory Seller.fromJson(Map<String, dynamic>? json) => Seller(
        ...
        userStatus: int.parse(json?["user_status"]),
        termsCondition: int.parse(json?["terms_condition"]),
        address: json?["address"],
        state: json?["state"],
        about: json?["about"],
        postCode: json?["post_code"],
